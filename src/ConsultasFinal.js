...
/* 
    2ª consulta: 
    Calculo el precio de venta de cada plato, resultado de la aplicación 
    de un impuesto al coste de fabricación de cada plato. Y, además
...
/* 
    3ª consulta: 
    Muestra los platos, los ingredientes que lo forman y si es un plato recomendable
     si quieres perder peso en función de sus calorías.
*/
...
/* 
    4ª consulta: 
    Agrupar según intervalos los platos mediante sus calorias. Se mostrarán cuantos platos 
    hay en cada intervalo, el nombre del mismo y 
...
/* 
    5ª consulta: 
    Averigua los ingredientes que caducarán en el próximo mes, y como de urgente es reponerlos 
    en función del número de platos que necesiten
    dicho ingrediente.
*/
